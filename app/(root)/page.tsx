...
export const metadata: Metadata = {
  ...
  description:
    "Salahudin Abbasi - Full Stack MERN & NestJS Developer specializing in React, Next.js, Node.js, NestJS, TypeScript, scalable backend systems, real-time applications, and cloud deployment. Explore my projects, experience, and professional work.",
  alternates: {
    ...
    <ClientPageWrapper>
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:pt-6 lg:pt-12 min-h-screen flex items-center justify-center relative">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          >
            Full Stack MERN & NestJS Developer
          </AnimatedText>


          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
              Salahudin Abbasi - Full Stack MERN & NestJS Developer specializing
              in React, Next.js, Node.js, NestJS, TypeScript, scalable backend
              systems, real-time applications, and cloud deployment. Explore my
